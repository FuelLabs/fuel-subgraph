...
export function id_of_type(typeId: TypeId): usize {
  switch (typeId) {
     ...
     * Fuel type ids
     */
    case TypeId.FuelBlock:
      return idof<fuel.Block>();
    // case TypeId.FuelScript:
    //   return idof<starknet.Transaction>();
    // case TypeId.FuelCreate:
    //   return idof<Array<starknet.TransactionType>>();
    // case TypeId.FuelMint:
    //   return idof<starknet.Event>();
    // case TypeId.FuelInput:
    //   return idof<Array<Bytes>>();
    // case TypeId.FuelCoin:
    //   return idof<Array<Bytes>>();
    // case TypeId.FuelMessage:
    //   return idof<Array<Bytes>>();
    // case TypeId.FuelOutput:
    //   return idof<Array<Bytes>>();
    // case TypeId.FuelOutputCoin:
    //   return idof<Array<Bytes>>();
    // case TypeId.FuelOutputContractCreated:
    //   return idof<Array<Bytes>>();
    // case TypeId.FuelInputContract:
    //   return idof<Array<Bytes>>();
    // case TypeId.FuelOutputContract:
    //   return idof<Array<Bytes>>();
    // case TypeId.FuelStorageSlot:
    //   return idof<Array<Bytes>>();
    // case TypeId.FuelUtxoId:
    //   return idof<Array<Bytes>>();
    // case TypeId.FuelTxPointer:
    //   return idof<Array<Bytes>>();
    // case TypeId.FuelPolicies:
    //   return idof<Array<Bytes>>();
    // case TypeId.FuelTransaction:
    //   return idof<Array<Bytes>>();
    // case TypeId.FuelTransactionArray:
    //   return idof<Array<Bytes>>();
    // case TypeId.FuelInputArray:
    //   return idof<Array<Bytes>>();
    // case TypeId.FuelOutputArray:
    //   return idof<Array<Bytes>>();
    // case TypeId.FuelStorageSlotArray:
    //   return idof<Array<Bytes>>();
    // case TypeId.FuelBytesArray:
    //   return idof<Array<Bytes>>();
    // case TypeId.FuelU64Array:
    //   return idof<Array<Bytes>>();
    default:
      return 0;
